...
"use strict";
/*!************************************************!*\
  !*** ./src/client/assets/javascript/client.js ***!
  \************************************************/
        ...
        switch (_context.prev = _context.next) {
          case 0:
            try {
              ...
              getRacers().then(function (racers) {
...
function setupClickHandlers() {
  document.addEventListener('click', function (event) {
    var target = event.target; // Race track form field
...
function runRace(_x2) {
  return _runRace.apply(this, arguments);
}

function _runRace() {
  _runRace = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(raceID) {
        ...
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            return _context5.abrupt("return", new Promise(function (resolve) {
              ...
              var raceInterval = setInterval( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
                var res;
...
function _runCountdown() {
  _runCountdown = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
    var timer;
...
function renderRacerCard(racer) {
  ...
  return "\n\t\t<li class=\"card podracer\" id=\"".concat(id, "\">\n\t\t\t<h3>").concat(driver_name, "</h3>\n\t\t\t<p>").concat(top_speed, "</p>\n\t\t\t<p>").concat(acceleration, "</p>\n\t\t\t<p>").concat(handling, "</p>\n\t\t</li>\n\t");
}
...
function renderTrackCard(track) {
  var id = track.id,
      name = track.name;
  return "\n\t\t<li id=\"".concat(id, "\" class=\"card track\">\n\t\t\t<h3>").concat(name, "</h3>\n\t\t</li>\n\t");
}

function renderCountdown(count) {
  return "\n\t\t<h2>Race Starts In...</h2>\n\t\t<p id=\"big-numbers\">".concat(count, "</p>\n\t");
}

function renderRaceStartView(track, racers) {
  return "\n\t\t<header>\n\t\t\t<h1>Race: ".concat(track.name, "</h1>\n\t\t</header>\n\t\t<main id=\"two-columns\">\n\t\t\t<section id=\"leaderBoard\">\n\t\t\t\t").concat(renderCountdown(3), "\n\t\t\t</section>\n\n\t\t\t<section id=\"accelerate\">\n\t\t\t\t<h2>Directions</h2>\n\t\t\t\t<p>Click the button as fast as you can to make your racer go faster!</p>\n\t\t\t\t<button id=\"gas-peddle\">Click Me To Win!</button>\n\t\t\t</section>\n\t\t</main>\n\t\t<footer></footer>\n\t");
}
...
function getTracks() {
  ...
  return fetch("".concat(SERVER, "/api/tracks")).then(function (response) {
...
function getRacers() {
  ...
  return fetch("".concat(SERVER, "/api/cars")).then(function (response) {
    return response.json();
  }).catch(function (error) {
    return console.log(error);
  });
